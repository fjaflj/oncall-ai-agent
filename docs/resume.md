...
Java 17、Spring Boot、Spring AI OpenAI、`gpt-5.6-terra`、`text-embedding-3-small`、Milvus、RAG、ReactAgent、Planner-Executor、Prometheus、MCP、SSE、Docker Compose、JUnit 5、GitHub Actions。
